  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen text-foreground">
      ...
      <div className="w-full max-w-2xl p-6 rounded-lg shadow-lg bg-card">
        <h1 className="text-2xl font-bold mb-4 text-center text-blue-900">HTML Previewer</h1>
        ...
        <div className="grid gap-4">
          ...
          <div className="flex justify-center">
            <div className="flex gap-2">
              <Button onClick={handlePreview} className="bg-blue-900">Generate Preview</Button>
              <Button onClick={handlePasteHtml} className="bg-blue-900">Paste HTML</Button>
            </div>
          </div>
